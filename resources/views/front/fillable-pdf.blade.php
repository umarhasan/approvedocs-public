    ...
    <section class="bg1ab">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h1 class="ax">Fillable <span class="service-inner">PDFs</span></h1>
                </div>
                <div class="col-md-1"></div>
            </div>
        </div>
    ...
    <section class="inner-service mt-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h4 class="e-sign-h4">Streamline Your Data Collection with Fillable PDFs</h4>
                    <p class="e-sign-p">Collect data quickly and efficiently with our fillable PDFs. Our intuitive
                        solution allows you to create accessible PDF forms to fill out, making it simple for clients to
                        provide you with the necessary information. <br> <br>
                        So, say goodbye to manual data entry and hello to more time for other essential tasks. </p>
                </div>
                <div class="col-md-6">
                    <img src="./assets/images/fillable-pdf.png" alt="E-Signature" class="e-sign" />
                </div>
            </div>
        </div>
    </section>
