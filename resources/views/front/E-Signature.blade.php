    ...
    <section class="bg1ab">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h1 class="ax">E- <span class="service-inner">Signatures</span></h1>
                </div>
                <div class="col-md-1"></div>
            </div>
        </div>
    ...
    <section class="inner-service mt-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h4 class="e-sign-h4">E-Signatures: Sign Digitally, Save Time and Effort.</h4>
                    <p class="e-sign-p">E-Signatures from us simplify the signing process for you and your clients. Say
                        goodbye to printing, signing, scanning, and sending physical documents. With our secure
                        electronic signature solution, you can sign and send documents from anywhere, at any time.</p>
                </div>
                <div class="col-md-6">
                    <img src="./assets/images/e-signature.png" alt="E-Signature" class="e-sign" />
                </div>
            </div>
        </div>
    </section>
