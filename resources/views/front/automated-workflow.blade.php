    ...
    <section class="bg1ab">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h1 class="ax">Automated <span class="service-inner">Workflow</span></h1>
                </div>
                <div class="col-md-1"></div>
            </div>
        </div>
    ...
    <section class="inner-service mt-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h4 class="e-sign-h4">Streamline Your Process with Automated Workflow.</h4>
                    <p class="e-sign-p">Say goodbye to manual tasks and hello to a more efficient process with our
                        automated workflow. Our solution allows you to automate repetitive tasks such as sending
                        follow-up reminders, so you can focus on more important things. Plus, with real-time
                        notifications, you'll always know what's happening with your documents.</p>
                </div>
                <div class="col-md-6">
                    <img src="./assets/images/automated.png" alt="E-Signature" class="e-sign" />
                </div>
            </div>
        </div>
    </section>
