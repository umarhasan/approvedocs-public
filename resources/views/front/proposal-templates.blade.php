    ...
    <section class="bg1ab">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h1 class="ax">Proposal <span class="service-inner">Templates</span></h1>
                </div>
                <div class="col-md-1"></div>
            </div>
        </div>
    </section>
    <section class="inner-service mt-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h4 class="e-sign-h4">Impress Your Clients with Stunning Proposals.</h4>
                    <p class="e-sign-p">You can create stunning, professional proposals in minutes with our proposal
                        templates. Our library of pre-built templates and customizable formatting options allow you to
                        create error-free proposals that align with your brand. Plus, with the option to lock content,
                        you can maintain control over the look, feel, and actions within every proposal.</p>
                </div>
                <div class="col-md-6">
                    <img src="./assets/images/proposal-temp.png" alt="E-Signature" class="e-sign" />
                </div>
            </div>
        </div>
    </section>
