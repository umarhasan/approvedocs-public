    ...
    <section class="bg1ab">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-10">
                    <h1 class="ax">Document <span class="service-inner">Management</span></h1>
                </div>
                <div class="col-md-1"></div>
            </div>
        </div>
    ...
    <section class="inner-service mt-5">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <h4 class="e-sign-h4">Effortlessly Manage Your Documents with Us.</h4>
                    <p class="e-sign-p">We make document management a breeze. Our cloud-based solution allows you to
                        easily send, receive, and store your proposals, contracts, and letters. Our real-time
                        notifications and collaboration tools keep everyone on the same page, so you can focus on
                        closing deals.</p>
                </div>
                <div class="col-md-6">
                    <img src="./assets/images/document.png" alt="E-Signature" class="e-sign" />
                </div>
            </div>
        </div>
    </section>
